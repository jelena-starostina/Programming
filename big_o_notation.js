...
function binarySearch(sorteArray, target) {
let left = 0
let right = sorteArray.length - 1

while (left <= right) {
    const mid = Math.floor((left + right) / 2);
    if (sorteArray[mid] === target) {
...
//---------------------------------------------------------------
//Линейно-логарифмическая сложность O(n log n) (Linearitmic time)
//Время выполнения растёт как n log n  с ростом входных данных
//"Золотая середина" между O(n) и O(n^2)
//Большинство эффективнях алгоритмов имеют такую сложность
console.log("---O(n log n) Линейно-логарифмическая сложность---");

//Пример. Сортировка массиваю
//Используем встроенный метод sort,который обычно реализован в большинстве движков JS

function sortArray(arr) {
    //мы сдесь не пишем свой алгоритм сортировки,
